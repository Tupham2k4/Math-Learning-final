...
const AddLessonModal = ({ isOpen, onClose, onSuccess }) => {
    ...
    // Lấy toàn bộ chapters mỗi khi Modal mở ra để lấy list mới nhất
    useEffect(() => {
        if (isOpen) {
            ...
            // Xoá dữ liệu cũ khi mở bảng lên lại
            setTitle('');
            setGrade('');
            setChapterId('');
            setError('');
    ...
    // Khi người dùng đổi khối lớp -> Xoá giá trị chapterId đang chọn để tránh lưu nhầm chương của lớp cũ
    useEffect(() => {
        setChapterId('');
    }, [grade]);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.data.success) {
                // Call success to close and reload list
                onSuccess();
            } else {
            ...
            <div className="add-lesson-modal">
                <div className="modal-header">
                    <div className="modal-title-group">
                        <div className="modal-lesson-icon-wrapper">
                            <FileText size={20} />
                        </div>
                ...
                <div className="modal-content">
                    ...
                    <form onSubmit={handleSubmit} className="add-lesson-form">
                        ...
                        <div className="form-group">
                            ...
                            <input 
                                type="text" 
                                placeholder="Nhập tên bài (ví dụ: Hình thoi)" 
                                value={title}
